...
{
    public partial class WithholdTaxType : Form
    {
        ...
        public WithholdTaxType()
        {
            InitializeComponent();
            Eve.FormController(this);
        }

        private void WithHoldType_Load(object sender, EventArgs e)
        {
            GetData();
            Clear();
        }
        ...
        private void GV_List_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (GV_List.Columns[e.ColumnIndex].HeaderText == "Edit")
            {
                ...
                {
                    Txt_Title.Text = DS.Tables[0].Rows[0]["Type"].ToString();
