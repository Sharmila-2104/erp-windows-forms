...
{
    public partial class TaxImpact : Form
    {
        ...
        private void TaxImpact_Load(object sender, EventArgs e)
        {
            GetData();
            Clear();
        }
        ...
        private void GV_List_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (GV_List.Columns[e.ColumnIndex].Name.Equals("DeleteColumn"))
            {
            ...
            else if (GV_List.Columns[e.ColumnIndex].Name.Equals("UpdateColumn"))
            {
                ...
                if (DS.Tables[0].Rows.Count > 0)
                {
                    ...
                    Txt_Title.Text = DS.Tables[0].Rows[0]["Impact"].ToString();
