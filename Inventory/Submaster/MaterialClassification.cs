...
{
    public partial class MaterialClassification : Form
    {
        ...
        private void MaterialClassification_Load(object sender, EventArgs e)
        {
            GetData();
            Clear();
        }
        ...
        private void GV_List_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (GV_List.Columns[e.ColumnIndex].HeaderText == "Edit")
            {
                ...
                if (DS.Tables[0].Rows.Count > 0)
                {
                    ...
                    Txt_Title.Text = DS.Tables[0].Rows[0]["Classification"].ToString();
